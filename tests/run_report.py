...
rec_t = {"quinella": [{"combo": [3, 7], "odds": 3.0}, {"combo": [3, 5], "odds": 4.0}, {"combo": [5, 7], "odds": 6.0},
         ...
         # 신호충족(3스냅샷+연속하락)이어야 추천 게이트 통과 → 삼복승 편성 로직 검증
         "history": [{"t": 1, "quinella": {"3+7": 6, "3+5": 8, "5+7": 10}, "win": {"3": 4, "7": 5, "5": 6, "11": 34},
                      "exacta": {"11+3": 12, "3+11": 60, "11+7": 13}},
                     {"t": 2, "quinella": {"3+7": 5, "3+5": 7, "5+7": 9}, "win": {"3": 3, "7": 4, "5": 5, "11": 32},
                      "exacta": {"11+3": 10, "3+11": 60, "11+7": 11}},
                     {"t": 3, "quinella": {"3+7": 4, "3+5": 6, "5+7": 8}, "win": {"3": 2, "7": 3, "5": 4, "11": 30},
